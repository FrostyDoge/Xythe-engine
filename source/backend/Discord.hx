...
class DiscordClient
{
	...
	public static function changePresence(details:String = 'Eating a Burrito...', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
